...
<CodeBlock filename="id_hashing.py" language="python">
...
<CodeBlock filename="query.sql" language="sql">
{`SELECT
    event_type,
    COUNT(*) as count,
...
<CodeBlock filename="top_endpoints.sql" language="sql">
{`SELECT
    endpoint,
    method,
    COUNT(*) as hits,
...
<CodeBlock filename="feature_adoption.sql" language="sql">
{`SELECT
    feature_name,
    action,
    COUNT(*) as count
...
<CodeBlock filename="overall_stats.sql" language="sql">
{`SELECT
...
<CodeBlock filename="check_indexes.sql" language="sql">
...
<CodeBlock filename="monitor_connections.sql" language="sql">
{`SELECT COUNT(*), state
...
<CodeBlock filename="models/analytics.py" language="python">
...
<CodeBlock filename="services/new_feature.py" language="python">
