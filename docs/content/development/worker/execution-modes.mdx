...
Tests are executed simultaneously using multiple Celery workers. This is the default mode and prov<CodeBlock filename="Diagram" language="text">
{`Test Configuration
    ↓
...
Para<CodeBlock filename="example.py" language="python">
...
</CodeBlock>tes is empty or doesn'<CodeBlock filename="example.py" language="python">
{`test_config = TestConfiguration(
    endpoint_id=endpoint.id,
    test_set_id=test_set.id,
    attributes={
...
Tests are executed one after another in sequence. Each test must comp<CodeBlock filename="example.text" language="text">
{`Test Configuration
    ↓
Test 1
    ↓
...
### Co<CodeBlock filename="example.py" language="python">
{`test_config = TestConfiguration(
    endpoint_id=endpoint.id,
    test_set_id=test_set.id,
    attributes={
        ...
        "execution_mod<CodeBlock filename="example.py" language="python">
...
### Execution Flo<CodeBlock filename="example.py" language="python">
{`{
    "status": "completed",
    "total_tests": 10,
    "tests_passed": 8,
...
#### Parallel Mo<CodeBlock filename="example.py" language="python">
...
#### Sequential Mode<CodeBlock filename="example.py" language="python">
...
| Sequential           | ~100 seconds   | Low    <CodeBlock filename="example.py" language="python">
...
</CodeBlock>ecutionMode.PARALLEL or Exec<CodeBlock filename="example.py" language="python">
...
</CodeBlock>ecuted simultaneously using<CodeBlock filename="example.py" language="python">
...
celery -A rhe<CodeBlock filename="Terminal" language="bash">
