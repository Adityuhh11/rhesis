...
- `query_params`: String containing <CodeBlock filename="example.json" language="json">
...
// request_headers
{
  ...
  "Authorization": "Bear<CodeBlock filename="example.json" language="json">
{`// request_body_template
{
...
- `response_mappings`: String containing <CodeBlock filename="example.json" language="json">
{`// response_mappings
{
  "output": "$.data.response"
}`}
</CodeBlock>ponse_mappings
{
  "output<CodeBlock filename="example.json" language="json">
{`// response_mappings
{
...
- `audience`: Target audience for the token (if requi<CodeBlock filename="example.json" language="json">
{`{
  "name": "Data Query API",
...
You can specify validation rules fo<CodeBlock filename="example.json" language="json">
{`{
  "validation_rules": {
