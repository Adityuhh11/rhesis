...
</CodeBlock>tch user error:", error);
    return null;
  }
}
...
Routes are protected<CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>tatic|_next/image|favicon.ico|api/auth).*)"],
};`}
</CodeBlock>

## Authentication Context

A React context is <CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>ithin an AuthProvider");
  }
  return context;
}
<CodeBlock filename="example.python" language="python">
...
The c<CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>he authentication process.</p>
    </div>
  );
}`}
</CodeBlock>

## Login <CodeBlock filename="example.tsx" language="tsx">
...
<CodeBlock filename="example.python" language="python">
{`
## Using Aut<CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>lick={logout}>Log Out</button>
    </div>
  );
}`}
</CodeBlock>
...
Role-based acc<CodeBlock filename="example.tsx" language="tsx">
...
<CodeBlock filename="example.python" language="python">
{`
## Auth Provider Setu<CodeBlock filename="example.tsx" language="tsx">
{`// app/layout.tsx
