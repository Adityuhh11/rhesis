...
API endpoints are defined in separate files for ea<CodeBlock filename="example.tsx" language="tsx">
...
API types are defined to<CodeBlock filename="example.tsx" language="tsx">
...
In server components, you can use the <CodeBlock filename="example.tsx" language="tsx">
...
In client components, you can use the API client with R<CodeBlock filename="example.tsx" language="tsx">
...
For form submissions and mutations, you can use server act<CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>ssage : "Failed to delete project",
    };
  }
}
...
The API client includes central<CodeBlock filename="example.tsx" language="tsx">
...
</CodeBlock>ick={reset}>Try again</button>
    </div>
  );
}`}
</CodeBlock>
