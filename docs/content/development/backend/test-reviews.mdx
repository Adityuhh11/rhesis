...
- `reviews`: List <CodeBlock filename="example.json" language="json">
{`{
  "metadata": {
...
</CodeBlock>erence": "Refusal Detection"
      }
    }
  ]
}
...
| `target`     | object            | Defines whether the review applies to a metric <CodeBlock filename="example.json" language="json">
{`{ "type": "test", "reference": null }
{ "type": "metric", "reference": "Refusal Detection" }`}
</CodeBlock>e": "metric", "reference": "Refusal Detection" }`}
</CodeBlock>
...
**File**: `apps/bac<CodeBlock filename="example.python" language="python">
...
**File**: `apps/back<CodeBlock filename="example.python" language="python">
{`# Review schemas
...
**Endpoint**: `POST /test_re<CodeBlock filename="example.json" language="json">
{`{
  ...
  "target": {
    ...
    "type": "test",
    "refer<CodeBlock filename="example.json" language="json">
{`{
...
**Endpoint**: `PUT /test_results/{test_result_id}/reviews/{re<CodeBlock filename="example.json" language="json">
{`{
  "comments": "UPDATED: After further review, this test passes all criteria"
}`}
</CodeBlock>further review, this test <CodeBlock filename="example.json" language="json">
{`{
  "review_id": "c370e2d7-f526-41c4-94f0-a6f25735a9b9",
  "status": {
    "status_id": "735acfa0-cca2-48a1-bb90-ba10b16f1cdb",
...
**Endpoint**: `DELETE /test_results/{test_resul<CodeBlock filename="example.json" language="json">
{`{
...
</CodeBlock>0-10T13:18:41.168149",
    "target": {...}
  }
}
<CodeBlock filename="example.text" language="text">
...
**Endpoint**: `GET /test<CodeBlock filename="example.json" language="json">
{`{
...
When modifying reviews, use SQLAlchemy<CodeBlock filename="example.python" language="python">
{`from sqlalchemy.orm.attributes import flag_modified

# After modifying test_reviews
flag_modified(test_result, "test_reviews")
db.commit()`}
</CodeBlock>odified(test_result, "test_reviews")
db.commit()
```
