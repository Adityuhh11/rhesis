...
<CodeBlock filename="require_current_user.py" language="python">
...
<CodeBlock filename="require_current_user_or_token.py" language="python">
...
<CodeBlock filename="create_access_token.py" language="python">
...
<CodeBlock filename="verify_token.py" language="python">
