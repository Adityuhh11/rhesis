...
The status is determined **once** by analyzing the `test_metri<CodeBlock filename="example.python" language="python">
...
</CodeBlock>tatus = "Pass" if all_metrics_passed else "Fail"
...
Test results contain a <CodeBlock filename="example.json" language="json">
{`{
  "execution_time": 1.23,
  "metrics": {
    "Answer Relevancy": {
...
</CodeBlock> Fluency": { "is_successful": true }
    }
  }
}
<CodeBlock filename="example.text" language="text">
{`
**Status:** Pass  
**Reason:** All<CodeBlock filename="example.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
      "Answer Relevancy": { "is_successful": true },
...
**Status:** Fail  
**Reason:** 1 out of<CodeBlock filename="example.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
...
</CodeBlock>Fluency": { "is_successful": false }
    }
  }
}
<CodeBlock filename="example.text" language="text">
...
</CodeBlock>etection": { "is_successful": true }
    }
  }
}`}
</CodeBlock>
...
### 1. Automated Test Execu<CodeBlock filename="example.python" language="python">
...
</CodeBlock>value = "Pass" if all_metrics_passed else "Fail"
<CodeBlock filename="example.python" language="python">
{`
### 2. API POST /<CodeBlock filename="example.python" language="python">
...
### 3. API PUT /test_r<CodeBlock filename="example.python" language="python">
{`# apps/backend/src/rhesis/backend/app/routers/test_result.py
...
### Email N<CodeBlock filename="example.python" language="python">
...
for result in test_results:
    ...
    if status_category == STATUS_CATEGORY_PASSED:
        ...
        tests_failed += 1`}
</CodeBlock>TATUS_CATEGORY_FAILED:
        tests_failed += 1`}
</CodeBlock>

### Test Result Stats API<CodeBlock filename="example.python" language="python">
...
The frontend al<CodeBlock filename="example.typescript" language="typescript">
...
</CodeBlock>originalPassed = passedMetrics === totalMetrics;`}
</CodeBlock>
...
If a test has no metrics or empty metrics, it's cou<CodeBlock filename="example.json" language="json">
{`{
