...
The status is determined in the chord call<CodeBlock filename="example.python" language="python">
...
Test stat<CodeBlock filename="example.python" language="python">
