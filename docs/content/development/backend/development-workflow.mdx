...
### Running the <CodeBlock filename="Terminal" language="bash">
...
The project uses `<CodeBlock filename="Terminal" language="bash">
...
### Linting<CodeBlock filename="Terminal" language="bash">
{`uv run --all-groups ruff check .`}
</CodeBlock>ssues:`}
</CodeBlock>bash
uv run --all-groups r<CodeBlock filename="Terminal" language="bash">
...
3. Use a test database (configured in `con<CodeBlock filename="Terminal" language="bash">
{`pytest`}
</CodeBlock>nning Tests

Run the te<CodeBlock filename="Terminal" language="bash">
...
U<CodeBlock filename="example.python" language="python">
