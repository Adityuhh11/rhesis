...
</CodeBlock>rl -H "Authorization: Bearer YOUR_A<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>e=metrics' -H 'Authoriz<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>024-12-31' -H 'Authorization: Bearer YOUR_TOKEN'
<CodeBlock filename="Terminal" language="bash">
{`
## Data Modes
...
### M<CodeBlock filename="Terminal" language="bash">
{`curl 'http://localhost:8080/test_results/stats?mode=summary' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>e=summary' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>

Returns only:

- `overall_pass_rates`
- `metada<CodeBlock filename="Terminal" language="bash">
{`curl 'http://localhost:8080/test_results/stats?mode=metrics&months=12' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>months=12' -H 'Authorization: Bearer YOUR_TOKEN'
<CodeBlock filename="Terminal" language="bash">
{`
Returns only:

- `metric_pass_rates` (Answer Fluency, Answer Relevancy, etc.<CodeBlock filename="Terminal" language="bash">
{`curl 'http://localhost:8080/test_results/stats?mode=timeline&months=6' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>&months=6' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>
...
All list-based filters support multiple values <CodeBlock filename="Terminal" language="bash">
{`# Multiple test runs
...
</CodeBlock>ids=uuid2' -H 'Authorization: Bearer YOUR_TO<CodeBlock filename="Terminal" language="bash">
{`# Multiple behaviors
...
</CodeBlock>ids=uuid2' -H 'Authorization<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>ids=lead1' -H 'Author<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>ealthcare' -H 'Authorization: Bearer YOUR_TOKEN'
...
</CodeBlock>ailable_topics": ["Healthcare<CodeBlock filename="example.json" language="json">
{`{
  "metric_pass_rates": {
    "Answer Fluency": {
      "total": 150,
...
</CodeBlock>&months=1' -H 'Authorization:<CodeBlock filename="Terminal" language="bash">
{`# Only metrics data
...
</CodeBlock>&months=6' -H 'Authorization:<CodeBlock filename="Terminal" language="bash">
{`# Timeline data only
...
</CodeBlock>024-06-30' -H 'Authorization: Bearer YOUR_TOKEN'`}
</CodeBlock>
<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>=timeline' -H 'Authorization: Bearer YOUR_TOKEN'
<CodeBlock filename="Terminal" language="bash">
{`
## Complete Examples

### Dashboard Im<CodeBlock filename="Terminal" language="bash">
{`curl 'http://localhost:8080/test_results/stats?mode=summary&months=1' -H 'Authorization: Bearer YOUR_TOKEN'
# Response time: ~50ms, Data size: ~5%`}
</CodeBlock>UR_TOKEN'
# Response time: ~50ms, <CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>ows test run performance for specific team leads`}
</CodeBlock>

### An<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>12-month metric trends for <CodeBlock filename="Terminal" language="bash">
...
# Compare specific <CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>High-priority urgent healthcare <CodeBlock filename="Terminal" language="bash">
...
# Regression test performance b<CodeBlock filename="Terminal" language="bash">
...
4. **Cache Results**: Cache responses for repeated q<CodeBlock filename="Terminal" language="bash">
...
</CodeBlock>r&behavior_ids=uuid1<CodeBlock filename="Terminal" language="bash">
{`# Unnecessarily broad queries
?mode=all&months=24

# Unfocused large datasets
?mode=all  # without any filters`}
</CodeBlock> large datasets
?mode=all  # without any filters
<CodeBlock filename="example.text" language="text">
{`
### Error H<CodeBlock filename="example.json" language="json">
{`{
  "detail": [
    {
      "type": "int_parsing",
...
</CodeBlock>h("/test_results/stat<CodeBlock filename="example.python" language="python">
{`import requests
