  ...
  data={[
    {
      ...
      children: [
              ...
              children: [
                {
                  ...
                  type: "folder",
                  children: [
                    { name: "__init__.py", type: "file", description: "Package initialization" },
                    {
                      name: "app",
                      type: "folder",
                      description: "Main application code",
                      children: [
                        { name: "main.py", type: "file", description: "FastAPI application entry point" },
                        { name: "database.py", type: "file", description: "Database connection and session management" },
                        { name: "crud.py", type: "file", description: "CRUD operations" },
                        { name: "models", type: "folder", description: "SQLAlchemy models" },
                        { name: "schemas", type: "folder", description: "Pydantic schemas" },
                        { name: "routers", type: "folder", description: "API endpoints" },
                        { name: "auth", type: "folder", description: "Authentication logic" },
                        { name: "utils", type: "folder", description: "Utility functions" },
                        { name: "services", type: "folder", description: "Business logic services" }
                      ]
                    },
                    { name: "alembic", type: "folder", description: "Database migrations" },
                    { name: "tasks", type: "folder", description: "Celery background tasks" },
                    { name: "metrics", type: "folder", description: "Application metrics" },
                    { name: "logging", type: "folder", description: "Logging configuration" }
                  ]
                }
              ]
            }
        ...
        { name: "pyproject.toml", type: "file", description: "Project dependencies and configuration" },
